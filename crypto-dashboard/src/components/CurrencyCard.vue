        ...
        <div class="row no-gutters coin-info">
            <div class="col-7">
                ...
                <div class="row no-gutters mt-1">
                    ...
                    <div class="col text-left">
                        ...
                        <div class="coin-price" v-if="ticker.price">{{ticker.price || '' }}<span style="font-size: large; font-weight: 700; padding-left: 3px;">{{info.quote}}</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="dd-container" :class="[{'show': showDropDown}]" v-click-outside="closeDropDown">
                ...
                <div class="dd-menu" v-if="showDropDown">
                    <span class="dd-item" @click="openDetails">Open(Or Double CLick)</span>
